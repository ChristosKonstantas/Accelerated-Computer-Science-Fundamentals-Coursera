...
std::vector<T> traverseLevels(GenericTree<T>& tree) {
  ...
  // std::vector< TreeNode* > children_vector;
  // std::vector<TreeNode*> root_vector;
  // root_vector.push_back(rootNodePtr);
  // while(!root_vector.empty()){  
  //   children_vector = rootNodePtr->childrenPtrs;
  //   while(!children_vector.empty())
  //   {
  //     rootNodePtr = children_vector.front();
  //     results.push_back(children_vector.front()->data);
  //     children_vector.erase(children_vector.begin());
  //     if(!rootNodePtr->childrenPtrs.empty())
  //       root_vector.push_back(rootNodePtr);
  //   } 
  //   root_vector.erase(root_vector.begin());
  //   rootNodePtr = root_vector.front();
  // }
  ...
  while (!root_vector.empty()) 
  {
      ...
      for (TreeNode* node : root_vector) 
      {
          results.push_back(node->data);  
          for (TreeNode* child : node->childrenPtrs)
              next_level.push_back(child); 
      }
      root_vector = next_level;  
  }
